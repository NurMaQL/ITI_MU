...
import 'package:iti_mu/credit3.dart';
import 'package:iti_mu/general3.dart';

class ThirdYear extends StatelessWidget {
  void Screen(BuildContext ctx, int n) {
    Navigator.of(ctx).push(MaterialPageRoute(builder: (_) {
      if (n == 8) return const Screen3();
