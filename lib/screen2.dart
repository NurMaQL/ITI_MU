...
import 'package:iti_mu/credit2.dart';
import 'package:iti_mu/general2.dart';

class SecondYear extends StatelessWidget {

  void Screen(BuildContext ctx, int n) {
    Navigator.of(ctx).push(MaterialPageRoute(builder: (_) {
      if (n == 11) return const Screen2();
